...
if DevAbs:get(Alpha.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(Alpha.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(Alpha.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(Alpha.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(Alpha.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(Alpha.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
AlphaName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if AlphaName then 
AlphaNames = DevAbs:smembers(Alpha.."Abs:Mute:Names"..msg.chat_id_) or ""
if AlphaNames and AlphaNames[1] then 
for i=1,#AlphaNames do 
if AlphaName:match("(.*)("..AlphaNames[i]..")(.*)") then 
...
DevAbs:set(Alpha.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(Alpha.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
